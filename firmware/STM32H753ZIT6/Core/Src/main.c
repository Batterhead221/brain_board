...
int main(void)
{
  ...
  const char boot_msg[] = "Brain_Board boot\r\n";
  HAL_UART_Transmit(&huart4, (uint8_t *)boot_msg, sizeof(boot_msg) - 1, HAL_MAX_DELAY);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, B_LED_Pin|G_LED_Pin|R_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DRV_CS_GPIO_Port, DRV_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RS485_DE_Pin|MTR_nSLEEP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DIR_Pin|STEP_Pin|ENABLE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DRV_CS_Pin RS485_DE_Pin MTR_nSLEEP_Pin */
  GPIO_InitStruct.Pin = DRV_CS_Pin|RS485_DE_Pin|MTR_nSLEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : DIR_Pin STEP_Pin ENABLE_Pin */
  ...
  /*Configure GPIO pins : nFAULT_Pin SD_CD_Pin */
  GPIO_InitStruct.Pin = nFAULT_Pin|SD_CD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : CRASH_FLAG_Pin HOME_FLAG_Pin */
  GPIO_InitStruct.Pin = CRASH_FLAG_Pin|HOME_FLAG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : JOG_FWD_Pin JOG_REV_Pin */
  GPIO_InitStruct.Pin = JOG_FWD_Pin|JOG_REV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(CRASH_FLAG_EXTI_IRQn, 6, 0);
  HAL_NVIC_EnableIRQ(CRASH_FLAG_EXTI_IRQn);
