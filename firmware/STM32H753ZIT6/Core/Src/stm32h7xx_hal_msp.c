...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PF5     ------> ADC3_INP4
    */
    GPIO_InitStruct.Pin = ADC_CURRENT_SENSE_Pin|ADC_24V_SENSE_Pin|ADC_5V_SENSE_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC3)
  {
    ...
    PF5     ------> ADC3_INP4
    */
    HAL_GPIO_DeInit(GPIOF, ADC_CURRENT_SENSE_Pin|ADC_24V_SENSE_Pin|ADC_5V_SENSE_Pin);
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  */
    ...
    PG6     ------> QUADSPI_BK1_NCS
    */
    GPIO_InitStruct.Pin = QSPI_IO3_Pin|QSPI_IO2_Pin|QSPI_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  */
    ...
    PD2     ------> SDMMC1_CMD
    */
    GPIO_InitStruct.Pin = SD_D0_MCU_Pin|SD_D1_MCU_Pin|SD_D2_Pin|SD_D3_Pin
                          |SD_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  if(hsd->Instance==SDMMC1)
  {
    ...
    PD2     ------> SDMMC1_CMD
    */
    HAL_GPIO_DeInit(GPIOC, SD_D0_MCU_Pin|SD_D1_MCU_Pin|SD_D2_Pin|SD_D3_Pin
                          |SD_CLK_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PD3     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = FRAM_MOSI_Pin|FRAM_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PD3     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, FRAM_MOSI_Pin|FRAM_MISO_Pin);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  if(hpcd->Instance==USB_OTG_FS)
  {
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, VBUS_Pin|USB_D__Pin|USB_D_A12_Pin);
